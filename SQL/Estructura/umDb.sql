...
CREATE NONCLUSTERED INDEX IX_tbl_periodos_Codigo_Periodo
ON dbo.tbl_periodos_academicos(Codigo_Periodo);

CREATE NONCLUSTERED INDEX IX_tbl_secciones_Id_Materia_Periodo_Id_Docente
ON dbo.tbl_secciones(Id_Materia_Periodo, Id_Docente);

CREATE NONCLUSTERED INDEX IX_tbl_grupos_Id_Periodo_Codigo_Grupo
ON dbo.tbl_grupos(Id_Periodo, Codigo_Grupo);

CREATE NONCLUSTERED INDEX IX_tbl_inscripciones_Id_Seccion_Id_Estudiante
ON dbo.tbl_inscripciones(Id_Seccion, Id_Estudiante);

CREATE NONCLUSTERED INDEX IX_tbl_grupos_inscripciones_Id_Grupo_Id_Inscripcion
ON dbo.tbl_grupos_inscripciones(Id_Grupo, Id_Inscripcion);

CREATE NONCLUSTERED INDEX IX_tbl_solicitudes_becas_Id_Beca_Programa_Id_Estudiante
ON dbo.tbl_solicitudes_becas(Id_Beca_Programa, Id_Estudiante);

CREATE NONCLUSTERED INDEX IX_tbl_sanciones_academicas_Id_Estudiante_Fecha_Registro
ON dbo.tbl_sanciones_academicas(Id_Estudiante, Fecha_Registro);
...
ON dbo.cls_becas_programas(Id_Tipo_Programa);
...
CREATE NONCLUSTERED INDEX IX_tbl_evaluaciones_instancias_Id_Seccion_Fecha_Programada
ON dbo.tbl_evaluaciones_instancias(Id_Seccion, Fecha_Programada);
